...
# One sampler row. This is the V1 measurement, and V2/V3/V5 reuse it so that
# every experiment reports occupancy the same way.
...
sample_header() {
  echo "ts,iso,metric_bytes,metric_http,metric_fs,du_http,du_fs,du_total,df_used,budget,occ_ratio,evictions,evicted_bytes,writes_skipped,fetch_errors,dropped,pinned,rebuilding"
}
sample_row() {
