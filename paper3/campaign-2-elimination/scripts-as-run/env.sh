...
# Central config for the spike-v5 (live validation of C1+C2) harness.
...
export STARGZ_FM_METRICS_ADDRESS="${STARGZ_FM_METRICS_ADDRESS:-0.0.0.0:9111}"
...
export OUR_SHA="${OUR_SHA:-f6547d99}"
